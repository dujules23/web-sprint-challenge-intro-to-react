...
-State is where we can store data to be used in our application

1. Describe props.

-Props is an object that takes data from the top-level component and allows it to be pass to other components in the Application.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

-Side effects are things that effect something outside of the scope. You sync side effects by using a dependency array. This will indicate when the side effect will happen
